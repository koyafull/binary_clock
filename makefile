...
binary_clock : main.o utils.o led_line.o led_panel.o GPIO.o debug_GPIO.o
	g++ -g -std=c++11 -o binary_clock main.o utils.o led_line.o led_panel.o GPIO.o debug_GPIO.o
	make clean
...
led_panel.o : src/led_panel.cpp headers/common.h headers/led_panel.h led_line.o GPIO.o debug_GPIO.o utils.o
